  ...
  const modelSelector = (
    <Select value={selectedModel} onValueChange={handleModelChange}>
      ...
      <SelectContent className="bg-popover border-border">
        ...
        {/* Always include current model even if claimed by this project */}
  ...
  return (
    <div className="flex flex-col h-full" data-ocid="editor.page">
      ...
      <div className="hidden md:flex flex-1 overflow-hidden">
        <div className="w-[45%] min-w-[300px] border-r border-border flex flex-col overflow-hidden">
          <ChatPanel
            messages={messages}
            isLoading={isLoading}
            error={error}
      ...
      <div className="md:hidden flex-1 overflow-hidden flex flex-col">
        ...
        >
          ...
          <TabsContent
            value="chat"
            className="flex-1 m-0 mt-2 overflow-hidden flex flex-col"
          >
            <ChatPanel
              messages={messages}
              isLoading={isLoading}
